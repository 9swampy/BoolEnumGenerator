...
[Generator]
public class BinaryEnumGenerator() : BaseGenerator<BinaryEnumSyntaxReceiver>(nameof(BinaryEnumGenerator), nameof(GenerateBinaryEnumAttribute))
{
...
public class {typeName} : SmartEnumWrapper<{typeName}, ProxyEnum>, IEquatable<ProxyEnum>, IComparable<ProxyEnum>, IEquatable<ProxyEnumWrapper<{typeName}, ProxyEnum>>, IComparable<ProxyEnumWrapper<{typeName}, ProxyEnum>>
{{
